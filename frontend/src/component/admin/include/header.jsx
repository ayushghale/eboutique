              ...
              <li>
                ...
                <label class="relative m-0 block h-7.5 w-14 rounded-full">
                  <span class="absolute left-1 top-1/2 flex h-6 w-6 -translate-y-1/2 translate-x-0 items-center justify-center rounded-full bg-white shadow-switcher duration-75 ease-linear">
                    ...
                    <button class="hidden dark:inline-block">
                      <svg
                        width="16"
                        height="16"
                        viewBox="0 0 16 16"
                ...
                >
                  <ul class="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
                    <li>
                      <a
                        href="profile.html"
                        class="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base dark:text-white dark:hover:text-primary"
                      >
                        <svg
                          class="fill-current"
                          width="22"
