          ...
          <div className="flex items-center gap-3 2xsm:gap-7">
              ...
              <li>
                ...
                <label className="relative m-0 block h-7.5 w-14 rounded-full">
                  <span className="absolute left-1 top-1/2 flex h-6 w-6 -translate-y-1/2 translate-x-0 items-center justify-center rounded-full bg-white shadow-switcher duration-75 ease-linear">
                    ...
                    <button className="hidden dark:inline-block">
                      <svg
                        width="16"
                        height="16"
                        viewBox="0 0 16 16"
            ...
            >
              <a
                ...
                href="##"
                onClick={() => handleDropdownToggle("userAccount")}
              ...
              >
                <span className="hidden text-right lg:block">
                  ...
                  <span className="block text-xs font-medium"></span>
                </span>
                ...
                >
                  <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
                    <li>
                      <a
                        href="profile.html"
                        className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base dark:text-white dark:hover:text-primary"
                      >
                        <svg
