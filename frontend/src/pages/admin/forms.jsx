import { CheckBox2 } from "../../component/admin/forms/checkBox.jsx";
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <nav>
            <ol class="flex items-center gap-2">
              <li>
                <a class="font-medium dark:text-white" href="/dashboard">
                  Dashboard /
                </a>
              </li>
